...
import SmoothingFilters from './SmoothingFilter';
import ThresholdingFilters from './ThresholdingFilter';
import ContourFilters from './ContourFilter';
...
export default class FilterProcessor {
    ...
    process() {
        ...
        if (["blur", "gaussian_blur", "median_blur", "bilateral_filter"].indexOf(this.type) >  -1) {
            const filter = new SmoothingFilters(this.type, this.getInputImage());
